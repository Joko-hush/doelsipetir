                                 ...
                                 <?php $n = 1;
                                    foreach ($approve as $app) : ?>
                                     <tr>
                                         ...
                                         <td><?= $app['email']; ?></td>
                                         <td>
                                             <a href="<?= base_url('personalia/lihat') . '?kdstaff=' . $app['KDSTAFF']; ?>" class="btn btn-success">Lihat</a>
                                             <!-- <a data-bs-toggle="modal" data-bs-target="#exampleModal" class="btn btn-success">Lihat</a> -->
