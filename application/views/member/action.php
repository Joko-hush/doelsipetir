...
switch (@$_GET['action']) {
    ...
    case 'absendd':
        ...
        //     Atau silahkan pilih dinas luar jika anda sedang berdinas luar";
        // }
        // if ($lat <= (-6.88858)) {
        //     echo "Anda tidak berada di Rumah Sakit Dustira. Jika Anda di Dustira silahkan cek setting GPS anda agar lebih akurat Atau silahkan pilih dinas luar jika anda sedang berdinas luar.";
        // }
        // if ($long < (107.53184)) {
        //     echo "Anda tidak berada di Rumah Sakit Dustira. Jika Anda di Dustira silahkan cek setting GPS anda agar lebih akurat Atau silahkan pilih dinas luar jika anda sedang berdinas luar.";
        // }
